...
# Obs: Caso fique confuso com os valores o investimento está milhares e retorno em milhos
...
tabela = pd.read_csv(r"C:\Users\Quach\Desktop\Estudo\Home\Intensivão de Python 2\Aula4\advertising.csv")
#print(tabela)
...
novos = pd.read_csv(r"C:\Users\Quach\Desktop\Estudo\Home\Intensivão de Python 2\Aula4\novos.csv") # Importa nova tabela de valores
